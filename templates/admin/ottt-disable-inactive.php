...
$getCustomersSQL = "SELECT * FROM `$customerTable` WHERE `ottt_customer_last_viewed` < $minLastViewed `ottt_customer_success` = 1 ORDER BY `ottt_customer_last_viewed` ASC;";
echo var_dump($getCustomerSQL);
