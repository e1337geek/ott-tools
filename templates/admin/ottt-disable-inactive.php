    ...
    <div id="poststuff">
        <table style="min-width: 50%;">
            ...
            <tr>
                ...
                <td><?php $customer['ottt_customer_last_viewed'] ? echo gmdate("Y-m-d", $customer['ottt_customer_last_viewed']):;?></td>
                <td><?php $customer['ottt_customer_disabled'] ? echo gmdate("Y-m-d", $customer['ottt_customer_disabled']):;?></td>
            </tr>
